...
The following theorem says, essentially, that equinumerosity is an equivalence relation. (The caveat is that so far we have spoken only of relations between sets, and the collection of all sets is not itself a set.)
